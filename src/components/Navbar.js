    ...
    return (
        <div className="main-menu">
            <nav data-aos="fade-down" className="navbar navbar-expand-sm navbar-dark container">
                <a className="navbar-brand text-white font-weight-bold" href="/"><img  alt='logo' src='https://res.cloudinary.com/moversng/image/upload/v1598887746/easycrmx2_kqmi0r.svg' className='logo border-red'/></a>
