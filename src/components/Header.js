                ...
                <div className="row">
                    <div className="col-lg-5 col-md-7 my-auto">
                        <div className="header-content text-white" >
                            <h2 data-aos="fade-down-left" className="mb-5">Manage customer data  and grow your business efficiently with <img alt='logo' src='https://res.cloudinary.com/moversng/image/upload/v1598887746/easycrmx2_kqmi0r.svg' className='logo'/></h2>
